...
if (isset($_POST['submit'])) { 
	...
	$query = "INSERT INTO applicant( first_name,	last_name,	gender, date_of_birth, highest_academic_level, province, district, sector, cell, email, password, learning_option_id) VALUES ('$first_name','$last_name','$gender','$date_of_birth', '$highest_academic_level', '$province', '$district', '$sector', '$cell', '$email', '$password', '$learning_option_id')";
